...
return [
    ...
    'markdown' => [
        ...
        'elements' => [
            ...
            'code' => ['class' => 'text-sm border text-gray-600 bg-gray-100 px-2 py-0.5 rounded font-mono'],
            'em' => ['class' => ''],
            'hr' => ['class' => 'my-4'],
            'h1' => ['class' => ''],
            'h2' => ['class' => 'mt-16 mb-8 text-2xl ml-0 md:-ml-7 text-3xl font-normal flex gap-2 group'],
            'h3' => ['class' => 'mt-12 mb-4 text-xl ml-0 md:-ml-5 font-normal flex gap-2 group'],
            'h4' => ['class' => ''],
            'h5' => ['class' => ''],
            'h6' => ['class' => ''],
            'p' => ['class' => ''],
